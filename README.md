...
*filter_by_currency* - 
cоздает итератор, который поочередно выдает транзакции, где валюта операции соответствует заданной
...
возвращает описания транзакций из передаваемого списка
