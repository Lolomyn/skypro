...
def test_log_console_no_args(capsys):
    ...
    func3()
    captured = capsys.readouterr()
    assert captured.out == "func3 error: test_log_console_no_args.<locals>.func3() missing 2 required positional " \
...
def test_log_file_no_args():
    ...
    assert last_line == "func4 error: test_log_file_no_args.<locals>.func4() missing 2 required " \
